...
Locals enum and the run_local dispatcher. Option chain fetching has its own
...
class Locals(Enum):
    """Available core-fetcher example workflows."""
...
if __name__ == '__main__':
    run_local(local=Locals.VOL_SURFACE)
